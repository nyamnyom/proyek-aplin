...
<body>
    <div class="auth-box text-center">
        ...
        <input type="email" class="form-control mb-2" placeholder="Email@domain.com" />
        <div class="input-group mb-2">
            <span class="input-group-text">+62</span>
            <input type="tel" class="form-control" placeholder="800-888-888" />
        </div>

        <a href="/"><button class="btn btn-black w-100 mb-3" onclick="register()">Sign up</button></a>
